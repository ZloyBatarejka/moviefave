...
const Form: React.FC = () => {
    ...
    const searchHandler = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    const handlInput = (event: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    const nextHandler = (): void => {
        ...
        flag.length ? dispatch(genreSearch(genreButton[flag], next, range)) : dispatch(searchApiHandler(title, next));
    };
    ...
    const ratingSortHandler = (): void => {
        dispatch(sort(movies, "rating"));
    };
    const yearSortHandler = (): void => {
